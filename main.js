...
var ASM_CONSTS = {
  93588: () => { if (document.fullscreenElement) return 1; },  
 93634: () => { return document.getElementById('canvas').width; },  
 93686: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93754: () => { document.exitFullscreen(); },  
 93781: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93854: () => { if (document.fullscreenElement) return 1; },  
 93900: () => { return document.getElementById('canvas').width; },  
 93952: () => { return screen.width; },  
 93977: () => { document.exitFullscreen(); },  
 94004: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94137: () => { return window.innerWidth; },  
 94163: () => { return window.innerHeight; },  
 ...
 94356: () => { if (document.fullscreenElement) return 1; },  
 94402: () => { return document.getElementById('canvas').width; },  
 94454: () => { return screen.width; },  
 94479: () => { return window.innerWidth; },  
 94505: () => { return window.innerHeight; },  
 94532: () => { if (document.fullscreenElement) return 1; },  
 94578: () => { return document.getElementById('canvas').width; },  
 94630: () => { return screen.width; },  
 94655: () => { document.exitFullscreen(); },  
 94682: () => { if (document.fullscreenElement) return 1; },  
 94728: () => { return document.getElementById('canvas').width; },  
 94780: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94848: () => { document.exitFullscreen(); },  
 94875: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94933: () => { return screen.width; },  
 94958: () => { return screen.height; },  
 94984: () => { return window.screenX; },  
 95011: () => { return window.screenY; },  
 95038: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95091: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95162: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95219: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95475: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95546: () => { if (document.fullscreenElement) return 1; },  
 95592: () => { return window.innerWidth; },  
 95618: () => { return window.innerHeight; },  
 95645: () => { if (document.pointerLockElement) return 1; }
};
